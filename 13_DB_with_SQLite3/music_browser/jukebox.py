...
class Scrollbox(tk.Listbox):
    ...
    def __init__(self, window, **kwargs):
        ...
        self.scrollbar = tk.Scrollbar(window, orient="vertical", command=self.yview)
        self.config(yscrollcommand=self.scrollbar.set)

    def grid(self, column, row, sticky="nsw", rowspan=1, columnspan=1, **kwargs):
...
if __name__ == "__main__":
    ...
    mainWindow.columnconfigure(index=3, weight=1)
