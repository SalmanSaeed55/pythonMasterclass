...
class Enemy:  # shorthand for class Enemy(object):
    ...
    def take_damage(self, damage):
        ...
        if remaining_points >= 0:
            ...
            print(f"I took {damage} points of damage and have {self._hit_points} points remaining")
        else:
            self._lives -= 1
            if self._lives > 0:
...
class Troll(Enemy):
    ...
    def __init__(self, name):
        super().__init__(name=name, lives=1, hit_points=1)
