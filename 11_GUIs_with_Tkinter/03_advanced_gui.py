...
listScroll = tk.Scrollbar(mainWindow, orient="vertical", command=fileList.yview)
...
monthSpinner = tk.Spinbox(dateFrame, width=5, values=["Jan", "Feb", "Mar", "April", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"])
yearSpinner = tk.Spinbox(dateFrame, width=5, from_=2000, to=2099)
...
cancelButton = tk.Button(mainWindow, text="Cancel", command=mainWindow.destroy)
